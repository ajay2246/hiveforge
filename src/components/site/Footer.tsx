      ...
      <footer className="border-t bg-white/30">
        <div className="mx-auto max-w-6xl px-4 py-12">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-zinc-600">
                Enterprise-grade software engineering. Building scalable platforms and modern web applications.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <nav className="flex flex-col space-y-2 text-sm">
                <a className="text-zinc-600 transition hover:text-zinc-900" href="#services">
                  Services
                </a>
                <a className="text-zinc-600 transition hover:text-zinc-900" href="#work">
                  Experience
                </a>
                <a className="text-zinc-600 transition hover:text-zinc-900" href="#about">
                  About
                </a>
                <a className="text-zinc-600 transition hover:text-zinc-900" href="#contact">
                  Contact
                </a>
              </nav>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col space-y-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-sm text-zinc-600 transition hover:text-amber-600"
                ...
                <a
                  href="mailto:ajaykancheti99@gmail.com"
                  className="inline-flex items-center gap-2 text-sm text-zinc-600 transition hover:text-amber-600"
                >
          ...
          <div className="mt-8 border-t pt-8 text-center text-sm text-zinc-600">
            <p>© {new Date().getFullYear()} HiveForge.dev. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
